...
export class BusinessService {
  ...
  private apiUrl = 'https://businessnewenvironment.onrender.com/api/Business';
  private cus_ApiUrl = 'https://businessnewenvironment.onrender.com/api/Customer';
  private businessRating_ApiUrl = 'https://businessnewenvironment.onrender.com/api/BusinessRating';
